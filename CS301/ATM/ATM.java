...
public class ATM extends JFrame
{
   ...
   private void createUserInterface()
   {
      ...
      buttonsJPanel.setBounds( 44, 160, 276, 200 );
      ...
      withdrawJButton.addActionListener(
		...
		// set up depositJButton
      depositJButton = new JButton();
      depositJButton.setBounds( 149, 145, 72, 24 );
      depositJButton.setText( "Deposit" );
      depositJButton.setBorder(
         BorderFactory.createRaisedBevelBorder() );
      depositJButton.setEnabled( false );
      buttonsJPanel.add( depositJButton );
      depositJButton.addActionListener(

         new ActionListener() // anonymous inner class
         {
            // event handler called when depositJButton is clicked
            public void actionPerformed( ActionEvent event )
            {
      ...
      accountNumberJPanel.setBounds( 44, 370, 276, 48 );
      ...
      setSize( 375, 460 ); // set window size
   ...
   private void enterJButtonActionPerformed( ActionEvent event )
   {
      if ( action == ENTER_PIN ) // checking PIN
      {
         ...
         if ( userPIN.equals( pin ) )
         {
            ...
            // enable balanceJButton, withdrawJButton, and depositJButton
      ...
      else if ( action == WITHDRAWAL ) // process withdrawal
      {
		...
		else if ( action == DEPOSIT ) // process withdrawal
      {
         enterJButton.setEnabled( false ); // disable enterJButton
   ...
   private void withdrawJButtonActionPerformed( ActionEvent event )
   {
	...
	private void depositJButtonActionPerformed( ActionEvent event )
   {
      // disable Balance and Withdraw JButtons
      balanceJButton.setEnabled( false );
      withdrawJButton.setEnabled( false );
	 ...
	 private void deposit( double depositAmount )
   {
      balance += depositAmount; // calculate new balance
         ...
         // display balance information to user
         messageJTextArea.setText( "The deposit amount is $" +
            dollars.format( depositAmount ) + "." );
   ...
   public static void main( String[] args ) 
   {
      ...
      //{
         ...
         String databaseDriver = "com.mysql.jdbc.Driver";
   		String databaseURL = "http://www.boehnecamp.com/phpMyAdmin/razorsql_mysql_bridge.php?database=ATM&tablename=accountInformation";
